...
const Ta = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  throttle: mi,
  timeToSecond: Nt
}, Symbol.toStringTag, { value: "Module" })), a = "mfuns-player", Di = "3.0.0-alpha.15", Ni = "20c15bb", Ii = "https://github.com/Mfuns-cn/mfunsPlayer/tree/v3-beta", zi = [
...
const cn = (
  ...
  <div class="${a}-about-version">Mfuns Player (Meon) | version ${ot.version}-${ot.gitHash}</div>
  <div>github：<a href="${Ii}" target="_blank">mfuns-cn/mfuns-player-meon</a></div>
  <div>开发者：</div>
